	...
	<body>
		<div id='page' data-role='page'>
			...
			<div id='content' data-role='content'>
				...
				<div id="dropBal" style=" display: none; padding: 5px;color:rgb(2,130,199); font-family:'Times New Roman', Times, serif;
				font-weight: bold;font-size: smaller; border: 1px solid rgb(197,199,199);border-radius: 3px;"></div>
				...
				<div id="dropUtil" style="display: none; padding: 5px; border: 1px solid rgb(197,199,199);margin: 5px; margin-top: 0px;border-radius: 3px;">
					...
					<form>
						<label>
							<input name="checkboxReq " type="radio" value="checkbook">
							ELECTRICITY</label>
						<label>
							<input name="checkboxReq " type="radio" value="atm">
							WATER</label>
						<label>
							<input name="checkboxReq " type="radio" value="atm">
							PHONE CREDIT</label>
